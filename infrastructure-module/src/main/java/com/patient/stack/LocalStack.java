...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props ){
        ...
        FargateService authFargateService =  createFargateService("AuthService","auth-service",List.of(4005),authServiceDb
                ,Map.of("JWT_SECRET","AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
                );
        authFargateService.getNode().addDependency(cfnHealthCheckAuth);
        authFargateService.getNode().addDependency(authServiceDb);


        FargateService billingFargateService =  createFargateService("BillingService","billing-service",List.of(4001,6565),null,null);
        FargateService analyticsFargateService =  createFargateService("AnalyticsService","analytics-service",List.of(4002),null,null);
        analyticsFargateService.getNode().addDependency(mfkCluster);
        ...
        patientService.getNode().addDependency(cfnHealthCheckPatient);
        patientService.getNode().addDependency(billingFargateService);
        patientService.getNode().addDependency(mfkCluster);
